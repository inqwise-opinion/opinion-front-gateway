...
image:https://github.com/inqwise-opinion/opinion-front-gateway/actions/workflows/github-security-code-scanning/codeql/badge.svg[CodeQL, link=https://github.com/inqwise-opinion/opinion-front-gateway/security/code-scanning]
